...
- Learn [Query DSL](/docs/objectql/protocol-spec/query-dsl) for basic queries
- Master [Mutation Operations](/docs/objectql/protocol-spec/mutation) for data modification
