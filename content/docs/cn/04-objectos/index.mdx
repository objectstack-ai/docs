...
1. **[平台架构](./platform-architecture)** - 理解 ObjectOS 的工作原理
2. **[身份与访问](./identity-access)** - 设置用户和权限
3. **[部署与运维](./deployment)** - 部署您的应用
...
- **初次接触 ObjectOS?** 从[平台架构](./platform-architecture)开始
- **设置安全?** 跳转到[身份与访问](./identity-access)
- **准备部署?** 查看[部署与运维](./deployment)
