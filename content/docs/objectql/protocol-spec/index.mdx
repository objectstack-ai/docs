...
### [Schema Definition](/docs/objectql/protocol-spec/schema-definition)
...
### [Query DSL](/docs/objectql/protocol-spec/query-dsl)
...
### [Aggregation Operations](/docs/objectql/protocol-spec/aggregation)
...
### [Mutation Operations](/docs/objectql/protocol-spec/mutation)
...
- Start with [Schema Definition](/docs/objectql/protocol-spec/schema-definition) to model your data
- Learn [Query DSL](/docs/objectql/protocol-spec/query-dsl) to retrieve data
- Master [Aggregation](/docs/objectql/protocol-spec/aggregation) for data analysis
- Understand [Mutation Operations](/docs/objectql/protocol-spec/mutation) for data modification
- Explore [Core Features](/docs/objectql/core-features) for advanced capabilities
- Check [Core Concepts](/docs/objectql/core-concepts) for foundational knowledge
