...
- **[Platform Architecture](/docs/objectos/platform-architecture)** - Review platform architecture
- **[Identity & Access](/docs/objectos/identity-access)** - Configure security and permissions
