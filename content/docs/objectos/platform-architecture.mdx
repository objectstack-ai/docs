...
ObjectOS serves as the runtime platform that orchestrates ObjectQL (data engine) and ObjectUI (interface concepts) into a cohesive application environment. This page explains how ObjectOS binds these components together and implements Local-First architecture.
