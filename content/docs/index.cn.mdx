...
ObjectStack 遵循**[宣言](/docs/framework/manifesto)**中概述的原则：
...
### 快速开始（5 分钟）
立即运行一个可工作的应用程序：
- **[快速开始指南](/docs/framework/quickstart)**：构建您的第一个 ObjectStack 应用

### 概念基础（30 分钟）
了解理念和架构：
- **[欢迎使用 ObjectStack](/docs/framework/welcome)**：平台概述和价值主张
- **[宣言](/docs/framework/manifesto)**：核心原则和设计决策
- **[架构指南](/docs/framework/architecture)**：技术设计和组件关系
...
### AI 辅助开发
了解如何利用 LLM 进行快速开发：
- **[AI 法典](/docs/framework/ai-codex)**：使用 AI 从协议规范生成 80% 的应用程序
