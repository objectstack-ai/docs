...
// Helper function to create social link items
function getSocialLinks(): LinkItemType[] {
  const socialLinks: LinkItemType[] = [];
  
  siteConfig.layout.navbar.socials.forEach((social) => {
    if (social.platform === 'github') {
      // GitHub is handled separately by githubUrl
      return;
    }
...
export const baseOptions: BaseLayoutProps = {
  ...
  links: [
    ...siteConfig.layout.navbar.links.map(link => ({
      text: link.text,
      url: link.url,
